module Api
  class TestSessionsController < ApplicationController
    def index
      ...
      test_sessions = test_sessions.where(screen_id: params[:screen_id]) if params[:screen_id]
      test_sessions = test_sessions.where(project_id: params[:project_id]) if params[:project_id]
